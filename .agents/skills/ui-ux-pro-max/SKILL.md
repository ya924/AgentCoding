...
| **Choose style / color / font** | "What style fits a fintech app?" Alb "推荐配色" | Step 2 (design system) |
...
- 当推荐表中找不到合适的图标时：
  - **优先继续从 Phosphor 的完整图标集中选择任何语义更貼切的图标**；
  - 如果 Phosphor 也沒有理想選項，可以使用 **Heroicons (`@heroicons/react`)** 作為備選，注意保持風格一致（線性/填充、筆畫粗細、圓角風格）。
